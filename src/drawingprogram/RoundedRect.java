...
public class RoundedRect extends Shape {
     ...
     */
    public RoundedRect(int startX, int startY, int endX, int endY, Color color, Color fillColor) {
        this.startX = startX;
        this.startY = startY;
        this.endX = endX;
        this.endY = endY;
    ...
    public void draw(Graphics2D g2d) {
        ...
        g2d.fillRoundRect(topLeftX, topLeftY, width, height, 20 ,30);
        // draw outline rectangle on top
        g2d.setColor(lineColor);
        g2d.drawRoundRect(topLeftX, topLeftY, width, height,20 ,30);
    }
